...
namespace GcStatistics.Sys.Common
{
    /// <summary>
    /// 搜索引擎关键字
    /// </summary>
    public class SearchKeyword
    {
        ...
        //搜索引擎关键字查询参数名称
        private string _RegexWord = string.Empty;
        ...
        public string SearchKey(string myString)
        {
            ...
            if (_EngineName != "")
            {
                ...
                if (_Coding == "gb2312")
                {
                    myString = System.Web.HttpUtility.UrlDecode(myString);//GetUTF8String(myString);
                }
                else
                {
        ...
        {
            string[] strArray = new string[] { "Google", "Baidu", "yisou", "MSN", "Yahoo", "live",
                                            "tom", "163", "TMCrawler", "iask", "Sogou", "soso", "youdao", "zhongsou", "3721",
                                            "openfind", "alltheweb", "lycos", "bing", "118114" };
            str = str.ToLower();
